...
import { AlertTriangle, Bell, TrendingDown, DollarSign, ArrowRight } from "lucide-react";
        ...
        <div className="container max-w-4xl text-center">
          ...
          <div className="mt-10 flex gap-4 justify-center">
            <Button size="lg" asChild>
              <Link to="/login">Começar agora <ArrowRight className="ml-2 h-4 w-4" /></Link>
            </Button>
      ...
      <section className="py-24">
        <div className="container max-w-3xl text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Entre na sua conta e comece a organizar seus contratos hoje.
          </p>
          <Button size="lg" asChild>
            <Link to="/login">Entrar <ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
      </section>
